	...
	<div class="wrap">
        ...
        <div id="main" class="main no-tab">
            <div class="page_filter">
            	<label class="frm_checkbox_label"><strong>发布文章</strong></label>
				<div class="page_filter_right">
            		<a href="admin.php?act=article" class="btn btn_default">返回</a>
            	</div>
            </div>
            <form action="admin.php?act=article&op=add" method="post" class="content-form" id="mall_article">
                    ...
                    <div class="info_group_cont">
                        <div class="group_inner">
                        	<div class="control_group">
                                ...
                                <div class="controls">
                                    <input type="text" name="article_title" class="form_input input_xxlarge" value="">
                                </div>
                            </div>
                            <div class="control_group">
                                <div class="control_label">文章排序：</div>
                                <div class="controls">
                                    <input type="text" name="article_sort" class="form_input input_xlarge" value="">
                                </div>
                            </div>
                            <div class="control_group">
								<div class="control_label">推荐到首页：</div>
								<div class="controls">
									<input type="hidden" id="article_recommend" name="article_recommend" value="0">
                            ...
                            <div class="control_group">
                                ...
                                <div class="controls">
                                	<?php showeditor('article_content', "", "100%", "600px", $style = "visibility:hidden;", "true", false);?>
                                </div>
                            </div> 
                        </div>
            		</div>
