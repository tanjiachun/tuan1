	...
	<div class="wrap">
        ...
        <div id="main" class="main no-tab">
        	<div class="page_filter">
            	<label class="frm_checkbox_label"><strong>新增分类</strong></label>
				<div class="page_filter_right">
            		<a href="admin.php?act=gclass" class="btn btn_default">返回</a>
            	</div>
            </div>    
            <form action="admin.php?act=gclass&op=add" method="post" class="content-form" id="mall_class">
                    ...
                    <div class="info_group_cont">
                        <div class="group_inner">
                            <div class="control_group">
                                ...
                                <div class="controls">
                                    <input type="text" name="class_name" class="form_input input_xxlarge" value="">
                                </div>
                            </div>
                            <div class="control_group">
                                <div class="control_label">排序：</div>
                                <div class="controls">
                                    <input type="text" name="class_sort" class="form_input input_xxlarge" value="">
                                    ...
                                    <div class="sku_group">
                                        <table class="table_sku_stock">
                                            ...
                                            <tbody id="brand_value">
                                                <tr>
                                                    <td><input type="hidden" name="brand_id[]" value="0" /><input class="form_input input_xlarge" name="brand_sort[]" type="text"></td>
                                                    <td><input class="form_input input_xlarge" style="width:200px !important;" name="brand_name[]" type="text"></td>
                                ...
                                <div class="controls">
                                    <div class="sku_group">
                                        <table class="table_sku_stock">
                                            ...
                                            <tbody id="type_value">
                                                <tr>
                                                    <td><input type="hidden" name="type_id[]" value="0" /><input class="form_input input_xlarge" name="type_sort[]" type="text"></td>
                                                    <td><input class="form_input input_xlarge" style="width:200px !important;" name="type_name[]" type="text"></td>
                                                    <td><a href="javascript:;" class="item_del">删除</a></td>
                                                </tr>
                                            </tbody>
                                            <tr>
                            ...
                            <div class="control_group">
                                <div class="control_label">商品属性：</div>
                                <div class="controls">
                                    <div class="sku_group">
                                        <table class="table_sku_stock">
                                            <thead>
                                            ...
                                            <tbody id="attr_value">
                                                <tr>
                                                    <td><input type="hidden" name="attr_id[0]" value="0" /><input class="form_input input_xlarge" name="attr_sort[0]" type="text"></td>
                                                    <td><input class="form_input input_xlarge" style="width:200px !important;" name="attr_name[0]" type="text"></td>
                                                    <td>
                                                    	<div class="sku_atom_list">
                                                            <ul>
                                                                <li><input type="text" name="attr_value_name[0][]" class="form_input input_xlarge" value=""></li><li><a href="javascript:;" class="btn btn_default attr_value_add" index="0">添加</a></li>
                                                            </ul>
                                                        </div>    
                                                    </td>
                                                    <td><a href="javascript:;" class="item_del">删除</a></td>
