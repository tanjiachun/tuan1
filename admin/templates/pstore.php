<?php include(template('common_header'));?>
	<div class="wrap">
            ...
            <ul>
                <li>
                    ...
                    <dl style="display:block">
						...
						<dd>
                            <a class="active" href="admin.php?act=pstore">店铺收益</a>
                        </dd>
						<?php } ?>
        ...
        <div id="main" class="main no-tab">
        	<div class="page_filter">
            	<label class="frm_checkbox_label"><strong>店铺收益</strong></label>
               	<form action="admin.php" method="get" id="search_form">
                	<input type="hidden" name="act" value="pstore" />
                ...
                <table class="goods_table">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span id="available_<?php echo $value['store_id'];?>"><?php echo $value['available_amount'];?></span></td>
                            <td class="td_opr" id="store_<?php echo $value['store_id'];?>">
                            	<a class="btn btn_primary" onclick="cash_open('<?php echo $value['store_id'];?>', '<?php echo $value['store_name'];?>');">汇款</a>
                                <p><a href="admin.php?act=pstore&op=profit&store_id=<?php echo $value['store_id'];?>">收入明细</a></p>
                            </td>
                        </tr>
                        <?php } ?>
                    </tbody>
    ...
    <script type="text/javascript" src="admin/templates/js/pstore.js"></script>
