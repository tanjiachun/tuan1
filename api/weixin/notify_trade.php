	...
	if($order_temp['order_state'] == 10) {
		...
		if($diff_amount >= -1 && $diff_amount<=1) {
			...
			foreach($order_ids as $order_id) {
				...
				$order_data['payment_name'] = '微信支付';
				$order_data['payment_code'] = 'weixin';
