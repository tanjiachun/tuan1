...
class nurse_cityControl extends BaseHomeControl {
    ...
    public function selectOp() {
        ...
        if(!empty($district_ipname)) {
            ...
            @header("Location: index.php?act=index&op=nurse");
            exit;
        } else {
            @header("Location: index.php?act=nurse_city");
            exit;
        }
    }
