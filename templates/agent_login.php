<?php include(template('common_header'));?>
	...
	<div class="register-c">
		<h1>
			<a class="active" id="login_tab">家政机构登录</a>
			<a id="register_tab">我要注册</a>
		</h1>
        <input type="hidden" id="formhash" name="formhash" value="<?php echo formhash();?>" />
        <table class="register-form" id="login_box">
			<tr>
				<th>手机号码</th>
				<td>
		...
		<table class="register-form" id="register_box" style="display:none;">
			<tr>
				<th>手机号码</th>
				<td>
