				...
				<div class="orderlist">
                    <div class="orderlist-head clearfix">
                        <ul>
                            ...
                            <li>
                                <a href="index.php?act=comment&op=goods" class="active">商品评价</a>
                            </li>
                            <li>
                                <a href="index.php?act=comment&op=pension">机构评价</a>
                            </li>						
                        </ul>
                    </div>
								...
								<tr class="tr-bd">
									<td>
										<div class="td-inner clearfix w-200">
											<div class="item-pic">
												<a href="index.php?act=goods&goods_id=<?php echo $value['goods_id'];?>" target="_blank"><img src="<?php echo $goods_list[$value['goods_id']]['goods_image'];?>"></a>
											</div>
											<div class="item-info">
												<a href="index.php?act=goods&goods_id=<?php echo $value['goods_id'];?>" target="_blank"><?php echo $goods_list[$value['goods_id']]['goods_name'];?></a>
												<p>￥<?php echo $goods_list[$value['goods_id']]['goods_price'];?></p>
											</div>
										</div>
									</td>
