...
<div id="message_content">
    <div class="message_content_left left">
        <ul>
            <li><span style="visibility: inherit;">●</span><a href="index.php?act=message_center" style="color:#ff6905;">交易通知(<?php echo $deal_count ?>)</a></li>
    ...
    <div class="message_content_right left">
        <div class="message_info">
            <h2 class="left">交易通知</h2> <span>未读<?php echo $count ?>条</span>
        </div>
