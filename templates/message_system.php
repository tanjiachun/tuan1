...
<div id="message_content">
    <div class="message_content_left left">
        <ul>
            ...
            <li><span style="visibility: inherit;">●</span><a style="color:#ff6905;" href="index.php?act=message_system">系统通知(<?php echo $system_count ?>)</a></li>
            <li><span>●</span><a href="index.php?act=message_interact">互动通知(<?php echo $interact_count ?>)</a></li>
            <li><span>●</span><a href="index.php?act=message_set">设置</a></li>
        </ul>
    </div>
    <div class="message_content_right left">
        <div class="message_info">
            <h2 class="left">系统通知</h2> <span>未读<?php echo $count ?>条</span>
        </div>
