<?php include(template('common_header'));?>
	...
	<div class="register-c">
        ...
        <input type="hidden" id="member_phone" name="member_phone" value="<?php echo $this->member['member_phone'];?>" />
		<table class="register-form">
            ...
            <tr>
                <th>可提供服务</th>
                <td>
                    <div class="keywordBox" style="width:550px;min-height:200px;border:1px solid #ddd;border-radius: 10px;">
                    </div>
			...
			<tr>
				<th>每月工作天数</th>
				<td class="code-input">
					<input type="text" id="nurse_days" name="nurse_days" class="form-input w-100" value=""> 天
					<div class="Validform-checktip Validform-wrong"></div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				<th>证件信息</th>
				<td>
					<span class="check nurse_qa active" nurse_qa="sf"><i class="iconfont icon-type"></i>身份证</span>
					<span class="check nurse_qa" nurse_qa="jk"><i class="iconfont icon-type"></i>健康证</span>
					<span class="check nurse_qa" nurse_qa="cn"><i class="iconfont icon-type"></i>催乳师证</span>
					<span class="check nurse_qa" nurse_qa="my"><i class="iconfont icon-type"></i>母婴护理师证</span>
					<span class="check nurse_qa" nurse_qa="yy"><i class="iconfont icon-type"></i>育婴师证</span>
					<span class="check nurse_qa" nurse_qa="ys"><i class="iconfont icon-type"></i>月嫂证</span>
				</td>
			</tr>
			<tr>
				<th>工作资质</th>
			...
			<tr>
				<th>我的要求</th>
				<td>
                	<textarea class="form-textarea w-10-9" id="nurse_content" name="nurse_content" rows="5"></textarea>
                    <div class="Validform-checktip Validform-wrong"></div>
					 <p class="help-desc">例如：一个月放假2天，不打扫卫生。</p>
                </td>
			</tr>
