<?php include(template('common_header'));?>
		...
		<div class="user-main">
			<div class="user-left">
				<div class="user-nav">
					...
					<ul>
                        ...
                        <li><a class="active" href="index.php?act=pension_profile&op=equipment">机构设施</a></li>
			...
			<div class="user-right">
				<div class="user-info">
                	<div class="edit-box">
						<div class="edit-body">
                            <div class="edit-body-title">机构设施</div>
                            <div class="edit-body-con">
                                <div class="form-list">
                                    ...
                                    <div class="form-item clearfix">
                                        <label>设施描述：</label>
                                        <div class="form-item-value">
                                            <textarea class="form-textarea w-10-9" id="equipment_content" name="equipment_content" rows="10"><?php echo $pension_field['equipment_content'];?></textarea>
	...
	<script type="text/javascript" src="templates/js/profile/pension_equipment.js"></script>
