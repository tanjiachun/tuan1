<?php include(template('common_header'));?>
		...
		<div class="user-main">
			<div class="user-left">
				<div class="user-nav">
					...
					<ul>
                        ...
                        <li><a class="active" href="index.php?act=pension_profile&op=service">机构服务</a></li>
					</ul>
				</div>
			</div>
			<div class="user-right">
				<div class="user-info">
                	<div class="edit-box">
						<div class="edit-body">
                            <div class="edit-body-title">机构服务</div>
                            <div class="edit-body-con">
                                <div class="form-list">
                                    ...
                                    <div class="form-item clearfix">
                                        <label>服务描述：</label>
                                        <div class="form-item-value">
                                            <textarea class="form-textarea w-10-9" id="service_content" name="service_content" rows="10"><?php echo $pension_field['service_content'];?></textarea>
	...
	<script type="text/javascript" src="templates/js/profile/pension_service.js"></script>
