<div class="modal-wrap w-400" id="storage-box">
    <div class="modal-hd">
    ...
    <div class="modal-bd">
        <div class="cont-modal">
            ...
            <div class="cont-item">
                ...
                <input type="text" class="spec_goods_storage" spec_id="<?php echo $value['spec_id'];?>" style="width: 100px;" value="<?php echo $value['spec_goods_storage'];?>">
            </div>
            <?php } ?>
        </div>
    </div>
    <div class="modal-ft">
         ...
         <a class="btn btn-primary" onclick="storagesubmit();">确定</a>
    </div>
</div>