			...
			<div class="user-left">
				<div class="user-nav">
					...
					<ul>
						...
						<li><a class="active" href="index.php?act=store_goods&op=goods_unshow">仓库商品</a></li>
			...
			<div class="user-right">
				...
				<div class="orderlist">
					<div class="orderlist-head clearfix">
						<ul>
							<li>
								<a href="index.php?act=store_goods&op=goods_unshow&state=unshow"<?php echo $state=='unshow' ? ' class="active"' : '';?>>未上架</a>
							</li>
							<li>
								<a href="index.php?act=store_goods&op=goods_unshow&state=pending"<?php echo $state=='pending' ? ' class="active"' : '';?>>待审核</a>
							</li>
							<li>
								<a href="index.php?act=store_goods&op=goods_unshow&state=illegal"<?php echo $state=='illegal' ? ' class="active"' : '';?>>已违规</a>
							</li>
						</ul>
						<div class="pull-right">
							<div class="search">
								<form action="index.php" method="get" id="search_form">
									...
									<input type="hidden" name="op" value="goods_unshow">
							...
							<tbody>
								<tr class="tool-row">
									<td colspan="5">
										...
										<?php if($state == 'unshow') { ?>
										<a class="btn btn-default use-express goods-show">上架</a>
										<?php } ?>
									</td>
								</tr>
							</tbody>
								...
								<tr class="tr-bd">
									<td>
										<div class="td-inner goods-inner clearfix">
											...
											<div class="item-info">
												<a><?php echo $value['goods_name'];?></a>
											</div>
										</div>
									</td>
									<td>¥<?php echo $value['goods_price'];?></a></td>
		...
		<div class="modal-bd">
			<div class="m-success-tip">
				<div class="tip-inner">
					...
					<h3 class="tip-message">您确定要上架吗？</h3>
				</div>
			</div>
		</div>
		<div class="modal-ft tc">
