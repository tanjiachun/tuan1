					...
					<div class="form-list">
						...
						<div class="form-item clearfix">
							...
							<div class="form-item-value">
								<input type="text" id="sp_name" name="sp_name" class="form-input w-400">
						...
						<div class="form-item clearfix">
							<label>规格排序：</label>
							<div class="form-item-value">
								<input type="text" id="sp_sort" name="sp_sort" class="form-input w-400">
							</div>
						</div>
						<div class="form-item clearfix">
							<label>规格类型：</label>
							<div class="form-item-value radio-box">
								<input type="hidden" id="sp_format" name="sp_format" value="text" />
								<span class="radio active" field_value="text" field_key="sp_format"><i class="iconfont icon-type"></i>文字</span>
								<span class="radio" field_value="image" field_key="sp_format"><i class="iconfont icon-type"></i>图片</span>
						...
						<div class="sku-group">
							<table class="table-sku-stock">
								...
								<tbody class="sp-value">
									<tr>
										<td>
											<input type="hidden" name="sp_value_id[]" value="0" />
											<input type="text" name="sp_value_sort[]" class="form-input w-50" value="">
										</td>
										<td>
											<input type="text" name="sp_value_name[]" class="form-input w-400" value="">
										</td>
										<td>
